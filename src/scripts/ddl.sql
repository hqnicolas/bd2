...
CREATE TABLE sinistros (
    ...
    apolice_id INTEGER REFERENCES apólices(id),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- Index on apólices.numero
CREATE INDEX idx_apólices_numero ON apólices(numero);

-- Index on apólices.cliente_id
CREATE INDEX idx_apólices_cliente_id ON apólices(cliente_id);

-- Index on apólices.celular_id
CREATE INDEX idx_apólices_celular_id ON apólices(celular_id);
